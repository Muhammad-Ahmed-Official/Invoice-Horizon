    ...
    <Card className="glass shadow-lg overflow-hidden animate-slide-up">
      <CardHeader className="bg-gradient-card border-b border-border p-2 sm:p-4">
        <div className="flex items-center justify-between">
          <CardTitle className="text-lg sm:text-2xl font-bold text-gradient-gold">Recent Invoices</CardTitle>
        </div>
      </CardHeader>
        ...
        <Table className="min-w-150 sm:min-w-full">
          ...
          <TableBody>
            {recentInvoices.map((invoice) => (
              <TableRow key={invoice.id} className="hover:bg-accent/10 transition text-xs sm:text-sm">
